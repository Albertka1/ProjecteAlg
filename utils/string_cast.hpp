...
namespace utils {
	...
	template <>
	std::string to_string<std::vector<std::string>>(const std::vector<std::string>& v) {
		std::string result = "";
		for (std::string s : v)
			result += s + "\n";
		return result;
	...
	template <class T>
	T from_string(const std::string& str) { return T(str); }
	template <>
	int from_string<int>(const std::string& str) { return std::stoi(str); }
	template <>
	long from_string<long>(const std::string& str) { return std::stol(str); }
	template <>
	long long from_string<long long>(const std::string& str) { return std::stoll(str); }
	template <>
	unsigned long from_string<unsigned long>(const std::string& str) { return std::stoul(str); }
	template <>
	unsigned long long from_string<unsigned long long>(const std::string& str) { return std::stoull(str); }
	template <>
	float from_string<float>(const std::string& str) { return std::stof(str); }
	template <>
	double from_string<double>(const std::string& str) { return std::stod(str); }
	template <>
	long double from_string<long double>(const std::string& str) { return std::stold(str); }
	template <>
	...
	template <>
	char from_string<char>(const std::string& str) { return str[0]; }
}
